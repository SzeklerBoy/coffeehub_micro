...
/**
 * Facility Service — groups migration.
 *
 ...
 *
 * Note: The monolith's FK from `orders.group_id → groups.id` is NOT present here.
...
return new class extends Migration
{
    ...
    {
        Schema::connection('coffeehub_facility')->create('groups', function (Blueprint $table) {
            $table->id();
    ...
    public function down(): void
    {
        ...
        Schema::connection('coffeehub_facility')->dropIfExists('groups');
    }
};
