<x-login-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block">
            ...
            @endif
            <label for="remember_me" class="mt-4 flex items-center">
                <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-coffee" name="remember">
                <span class="ms-2 text-sm text-gray-600 dark:text-gray-400">{{ __('Remember me') }}</span>
            </label>
        </div>
        <div class="flex items-center justify-end mt-4">
            <x-secondary-button class="ms-3" href="{{ route('orders.create') }}">
